...
doc_issue_country | false | Country code in ISO 3-letters format, i.e. ESP (Spain) / DEU (Germany) / ITA (Italy). It is required for Emila-Romagna/Abruzzo/Lombardia ISTATs.
...
rooms_occupied | false | Number of rooms occupied. Used for Emila-Romagna/Abruzzo/Lombardia ISTATs only.
